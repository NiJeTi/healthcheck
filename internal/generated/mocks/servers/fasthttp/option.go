...
import (
	fasthttp "github.com/nijeti/healthcheck/servers/fasthttp"
...
func (_m *MockOption) Execute(server *fasthttp.Server) {
	_m.Called(server)
}
...
func (_c *MockOption_Execute_Call) Run(run func(server *fasthttp.Server)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*fasthttp.Server))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*fasthttp.Server)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
